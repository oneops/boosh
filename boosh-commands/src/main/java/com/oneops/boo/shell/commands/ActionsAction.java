 ...
 * Display actions.
 */
@Command(name="boo/actions", description = "Display actions")
  ...
  extends TemplateActionSupport
{
  ...
  public Object execute(final @Nonnull CommandContext context) throws Exception {
    ...
    log.debug("Listing actions; platform={}, component={}", platform, component);
    List<String> actions = flow.listActions(platform, component);
